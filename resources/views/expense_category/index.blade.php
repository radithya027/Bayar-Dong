...
<section class="content-header" style="font-family: 'Poppins', sans-serif;">
    <h1 class="tw-text-xl md:tw-text-3xl tw-font-bold tw-text-black">@lang( 'expense.expense_categories' )
        <small class="tw-text-sm md:tw-text-base tw-text-gray-700 tw-font-semibold" style="font-family: 'Poppins', sans-serif;">@lang( 'expense.manage_your_expense_categories' )</small>
    </h1>
</section>
