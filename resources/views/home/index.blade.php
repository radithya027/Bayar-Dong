...
<div class="tw-pb-6 xl:tw-pb-0" style="background-color: #1E2B32 !important; border-color: rgba(30,43,50,0.3) !important;">
                                ...
                                <div
                                    ...
                                    <div class="tw-p-4 sm:tw-p-5">
                                        <div class="tw-flex tw-items-center tw-gap-4">
                                            ...
                                            <p class="tw-text-sm tw-font-medium tw-text-gray-500 tw-truncate tw-whitespace-nowrap" style="font-family: 'Poppins', sans-serif;">
                                                {{ __('home.total_sell') }}
                                            </p>
                                                <p
                                ...
                                <div
                                    ...
                                    <div class="tw-p-4 sm:tw-p-5">
                                        <div class="tw-flex tw-items-center tw-gap-4">
                                            ...
                                            <div class="tw-flex-1 tw-min-w-0">
                                                <p
                                                    class="tw-text-sm tw-font-medium tw-text-gray-500 tw-truncate tw-whitespace-nowrap" style="font-family: 'Poppins', sans-serif;">
            ...
            @if ($is_admin)
                <div class="tw-relative">
                    <div class="tw-absolute tw-inset-0 tw-grid" aria-hidden="true">
                        <div class="tw-bg-[#1E2B32]"></div>
                        <div class="tw-bg-gradient-to-r tw-from-[#1E2B32] tw-to-[#1E2B32] xl:tw-bg-none xl:tw-bg-gray-100">
                        </div>
                    </div>
                    ...
                    @if (!empty($all_locations))
                        <div
                            ...
                            <div class="tw-p-4 sm:tw-p-5">
                                ...
                                <div class="mt-6">
                                    <div class="w-full min-h-[400px] rounded-xl border border-gray-200 border-dashed bg-gray-50/50 flex items-center justify-center">
                                        <!-- Chart Container -->
