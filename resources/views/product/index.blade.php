                ...
                <div class="col-md-12">
                    <!-- Custom Tabs -->
                        <div class="nav-tabs-custom">
                            <ul class="nav nav-tabs" style="font-family: 'Poppins', sans-serif; font-weight: 600;">
                                <li class="active">
                                ...
                                @can('stock_report.view')
                                    <li>
                                        <a href="#product_stock_report" class="product_stock_report" data-toggle="tab"
                                            aria-expanded="true" style="font-family: 'Poppins', sans-serif; font-weight: 500;">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active " id="product_list_tab">
                                    @if ($is_admin)
                                        <a href="{{ action([\App\Http\Controllers\ProductController::class, 'downloadExcel']) }}" 
                                           class="tw-dw-btn tw-font-bold tw-text-white tw-border-none tw-rounded-full pull-right tw-m-2" 
                                           style="background-color: #1E2B32; font-family: 'Poppins', sans-serif;">
