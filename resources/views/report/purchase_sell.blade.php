...
<section class="content-header">
    <h1 style="font-family: 'Poppins', sans-serif;" class="tw-text-xl md:tw-text-3xl tw-font-bold tw-text-black">
        @lang('report.purchase_sell')
        <small style="font-family: 'Poppins', sans-serif;" class="tw-text-sm md:tw-text-base tw-text-gray-700 tw-font-semibold">
            @lang('report.purchase_sell_msg')
        </small>
    </h1>
</section>
...
<section class="content">
    <div class="print_section">
        <h2 style="font-family: 'Poppins', sans-serif;">{{ session()->get('business.name') }} - @lang('report.purchase_sell')</h2>
    </div>
    ...
    <div class="row no-print">
        ...
        <div class="col-md-2 col-xs-6">
            <div class="form-group pull-right">
                <div class="input-group">
                    <button type="button" class="tw-dw-btn tw-text-white tw-dw-btn-sm" id="purchase_sell_date_filter"
                        style="background-color: #1E2B32; border: none; padding: 8px 15px; border-radius: 5px; font-family: 'Poppins', sans-serif;">
                        <span>
    ...
    <div class="row">
        <div class="col-xs-12">
            @component('components.widget')
                ...
                @endslot
                <h3 class="text-muted" style="font-family: 'Poppins', sans-serif;">
    ...
    <div class="row no-print">
        <div class="col-sm-12 tw-mb-2">
            <button class="tw-dw-btn tw-dw-btn-primary tw-text-white pull-right" aria-label="Print"
                ...
                style="background-color: #1E2B32; border: none; padding: 10px 20px; 
