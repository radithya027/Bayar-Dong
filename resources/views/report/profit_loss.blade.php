...
@section('content')
    ...
    <section class="content-header" style="font-family: 'Poppins', sans-serif;">
        <h1 class="tw-text-xl md:tw-text-3xl tw-font-bold tw-text-black">@lang('report.profit_loss')</h1>
    </section>
        ...
        <div class="row no-print">
            ...
            <div class="col-md-2 col-xs-6">
                <div class="form-group pull-right">
                    <div class="input-group">
                        <button type="button" id="profit_loss_date_filter"
                            style="background-color: #1E2B32; border: none; padding: 8px 15px; border-radius: 5px; font-family: 'Poppins', sans-serif; color: white;">
                            <span>
