    ...
    <div class="col-sm-12">
        <div class="box box-solid"> <!--business info box start-->
            <div class="box-header">
                <div class="box-header">
                    <h3 class="box-title" style="font-family: 'Poppins', sans-serif;">
            ...
            <div class="box-body" style="font-family: 'Poppins', sans-serif;">
                <div class="form-group">
                    {!! Form::label('current_password', __('user.current_password') . ':', ['class' => 'col-sm-3 control-label', 'style' => 'font-family: Poppins, sans-serif;']) !!}
                    <div class="col-sm-9">
                        <div class="input-group">
                            <span class="input-group-addon">
                                <i class="fa fa-lock"></i>
                            </span>
                            {!! Form::password('current_password', ['class' => 'form-control', 'placeholder' => __('user.current_password'), 'required', 'style' => 'font-family: Poppins, sans-serif;']) !!}
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    {!! Form::label('new_password', __('user.new_password') . ':', ['class' => 'col-sm-3 control-label', 'style' => 'font-family: Poppins, sans-serif;']) !!}
                    <div class="col-sm-9">
                        <div class="input-group">
                            <span class="input-group-addon">
                                <i class="fa fa-lock"></i>
                            </span>
                            {!! Form::password('new_password', ['class' => 'form-control', 'placeholder' => __('user.new_password'), 'required', 'style' => 'font-family: Poppins, sans-serif;']) !!}
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    {!! Form::label('confirm_password', __('user.confirm_new_password') . ':', ['class' => 'col-sm-3 control-label', 'style' => 'font-family: Poppins, sans-serif;']) !!}
                    <div class="col-sm-9">
                        <div class="input-group">
                            <span class="input-group-addon">
                                <i class="fa fa-lock"></i>
                            </span>
                            {!! Form::password('confirm_password', ['class' => 'form-control', 'placeholder' => __('user.confirm_new_password'), 'required', 'style' => 'font-family: Poppins, sans-serif;']) !!}
                        </div>
                    </div>
                </div>
                <button type="submit" class="tw-dw-btn tw-dw-btn-primary tw-text-white pull-right" style="font-family: 'Poppins', sans-serif;">
...
<div class="row">
    <div class="col-sm-8">
        <div class="box box-solid"> <!--business info box start-->
            <div class="box-header">
                <div class="box-header">
                    <h3 class="box-title" style="font-family: 'Poppins', sans-serif;"> @lang('user.edit_profile')</h3>
                </div>
            </div>
            <div class="box-body" style="font-family: 'Poppins', sans-serif;">
    ...
    <div class="col-md-4" style="font-family: 'Poppins', sans-serif;">
        @component('components.widget', ['title' => __('lang_v1.profile_photo')])
            ...
            <div class="col-md-12">
                <div class="form-group">
                    {!! Form::label('profile_photo', __('lang_v1.upload_image') . ':', ['style' => 'font-family: Poppins, sans-serif;']) !!}
                    {!! Form::file('profile_photo', ['id' => 'profile_photo', 'accept' => 'image/*', 'style' => 'font-family: Poppins, sans-serif;']) !!}
                    <small>
                        <p class="help-block" style="font-family: Poppins, sans-serif;">
